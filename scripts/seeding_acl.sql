-- seeding après la mise en place de l'ACL

BEGIN;

TRUNCATE TABLE booking."event", booking.visitor, booking.booking, incident.incident, incident.comment RESTART IDENTITY;

INSERT INTO booking."event" (public_name, capacity, opening_hour, duration, open_duration) VALUES 
...
INSERT INTO booking.visitor (ticket_number, validity_start, validity_end) VALUES
-- billet valide
...
INSERT INTO booking.booking (visitor_id, event_id, places, scheduled_time) VALUES
...
INSERT INTO incident.incident (incident_number, nature, technician, open_date, close_date, event_id) VALUES
...
INSERT INTO incident.comment("text", "date", incident_id) VALUES
